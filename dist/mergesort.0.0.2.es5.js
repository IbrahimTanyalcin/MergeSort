...
(function (global, factory) {
    ...
    function insertionSort(arr, l, f) {
    ...
    function walk(arr, tree, f) {
      var hThreshold = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 8;
      var backtrack = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;

      outer: while (tree) {
        var leaf = tree.firstChild;
      ...
      outer: while (state) {
        switch (state) {
          case "down":
            ...
            node.firstChild.nextSibling = node.lastChild = {
              o: node.o + nL,
              l: node.l - nL,
              p: node,
              nextSibling: null,
    ...
    function index () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
        ...
        size: undef
          ...
          threshold = _ref$threshold === void 0 ? 16 : _ref$threshold,
          _ref$size = _ref.size,
          size = _ref$size === void 0 ? undef : _ref$size;

      if (size && typeof size !== "number") {
        throw new Error("Size must be of type number");
      }

      var hThreshold = threshold / 2,
      ...
      */
      instance = function instance(arr, f) {
